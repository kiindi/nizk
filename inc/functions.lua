...
.."\n★︎  التعديل » "..(redis:get(nk..'lock_edit'..msg.chat_id_) or 'false')
.."\n★︎  الروابط » "..(redis:get(nk..'lock_link'..msg.chat_id_) or 'false')
.."\n★︎  التاك » "..(redis:get(nk..'lock_tag'..msg.chat_id_) or 'false')
.."\n★︎  المعرفات » "..(redis:get(nk..'lock_username'..msg.chat_id_) or 'false')
.."\n\n★︎  التكرار » "..(redis:get(nk..'lock_flood'..msg.chat_id_) or 'false')
.."\n★︎  الكلايش » "..(redis:get(nk..'lock_spam'..msg.chat_id_) or 'false')
.."\n★︎  الويب » "..(redis:get(nk..'lock_webpage'..msg.chat_id_) or 'false')
.."\n★︎  الماركدوان » "..(redis:get(nk..'lock_markdown'..msg.chat_id_) or 'false')
.."\n★︎  البوتات بالطرد » "..(redis:get(nk..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n★︎  البوتات » "..(redis:get(nk..'lock_bots'..msg.chat_id_) or 'false')
.."\n★︎  عدد التكرار » "..(redis:get(nk..'num_msg_max'..msg.chat_id_) or 'false')
.."\n★︎  وقت التنظيف » "..(redis:get(nk..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n★︎ `اعدادات الوسائط :`\n"
...
.."\n★︎ الفشار » "..(redis:get(nk..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n★︎ الفارسيه » "..(redis:get(nk..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n★︎ الانكليزيه » "..(redis:get(nk..'lock_lang'..msg.chat_id_) or 'false')
.."\n★︎ الاضافه » "..(redis:get(nk..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒*`اعدادات اخرى : `"
.."\n** الترحيب » "..(redis:get(nk..'welcome:get'..msg.chat_id_) or 'false')
.."\n*★︎*  الردود » "..(redis:get(nk..'replay'..msg.chat_id_) or 'false')
.."\n*★︎*  الردود العشوائيه » "..(redis:get(nk.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n*★︎*  التحذير » "..(redis:get(nk..'lock_woring'..msg.chat_id_) or 'false')
.."\n*★︎ * الايدي » "..(redis:get(nk..'lock_id'..msg.chat_id_) or 'false')
.."\n*★︎* الرابط » "..(redis:get(nk..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*★︎* المغادره » "..(redis:get(nk..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*★︎* الحظر » "..(redis:get(nk..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*★︎* الحمايه » "..(redis:get(nk..'antiedit'..msg.chat_id_) or 'false')
.."\n*★︎* التاك للكل » "..(redis:get(nk..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*★︎* الايدي بالصوره » "..(redis:get(nk..'idphoto'..msg.chat_id_) or 'false')
.."\n*★︎* التحقق » "..(redis:get(nk.."lock_check"..msg.chat_id_) or 'false')
.."\n*★︎* التنظيف التلقائي » "..(redis:get(nk.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*★︎* ردود السورس » "..(redis:get(nk.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*★︎ * عدد التكرار » "..(redis:get(nk..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*★︎ *`اعدادات التقـييد :`\n"
.."\n*★︎* التقييد بالتوجيه » "..(redis:get(nk..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*★︎* التقييد بالصور » "..(redis:get(nk..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*★︎ * التقييد بالروابط » "..(redis:get(nk..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*★︎* التقييد بالمتحركه » "..(redis:get(nk..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*★︎* التقييد الفيديو » "..(redis:get(nk..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
