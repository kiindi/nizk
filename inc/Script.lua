...
if not msg.Director then return "★︎  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if 100 < tonumber(MsgText[2]) then return "★︎  حدود المسح ,  يجب ان تكون ما بين  *[2-100]*" end
...
return '★︎ اصدار سورس ويـزَرد*v'..version..'* \n'
end
...
sendMsg(arg.chat_id_,arg.id_,'★︎  عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس باسل يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
