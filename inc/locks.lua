...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الردود العشوائيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."lock_RandomRdod"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الردود العشوائيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الردود العشوائيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(ws.."lock_RandomRdod"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الردود العشوائيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الحظر والطرد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."lock_KickBan"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الحظر والطرد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الحظر والطرد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(ws.."lock_KickBan"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الحظر والطرد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل ردود السورس    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."lock_rdodSource"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل ردود السورس بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل  ردود السورس    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(ws.."lock_rdodSource"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل ردود السورس بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل التحقق    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )        else 
redis:del(ws.."lock_check"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل التحقق بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل التحقق    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )        else
redis:set(ws.."lock_check"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل التحقق بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل التنظيف التلقائي    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل التنظيف التلقائي بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل التنظيف التلقائي    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )        else
redis:set(ws.."lock_cleaner"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل التنظيف التلقائي بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل تاك للكل    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."lock_takkl"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل تاك للكل   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل تاك للكل    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."lock_takkl"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل تاك للكل بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل المغادره    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."lock_leftgroup"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل المغادره بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل المغادره    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(ws.."lock_leftgroup"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل المغادره بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end 
end,{msg=msg})
end 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الحمايه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."antiedit"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الحمايه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الحمايه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."antiedit"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الحمايه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الايدي بالصوره    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."idphoto"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الايدي بالصوره بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الايدي بالصوره    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."idphoto"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الايدي بالصوره بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
------Lock link Group ------------------- 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الرابط    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."lock_linkk"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الرابط بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الرابط    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."lock_linkk"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الرابط بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
------Lock waring ------------------- 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل التحذير    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."lock_woring"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل التحذير بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل التحذير    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."lock_woring"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل التحذير بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
------Lock id------------------- 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الايدي    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."lock_id"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الايدي بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الايدي    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:set(ws.."lock_id"..msg.chat_id_,true)  
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الايدي بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
------Lock welcome------------------- 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الترحيب    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(ws.."welcome:get"..msg.chat_id_,true)  
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الترحيب بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الترحيب    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."welcome:get"..msg.chat_id_) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الترحيب بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end 
end,{msg=msg})
end
------Lock all------------------- 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الكل بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end,{msg=msg})
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الكل بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end,{msg=msg})
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الوسائط بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end,{msg=msg})
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الوسائط بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end,{msg=msg})
...
if not msg.Admin then return "*★︎* هذا الامر يخص الادمنيه فقط  \n✮" end
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(ws..":tqeed_video:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الفيديو بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(ws..":tqeed_video:"..msg.chat_id_)
redis:set(ws..":tqeed_video:"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الفيديو بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )    end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الفيديو بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(ws..":tqeed_video:"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الفيديو بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل المتحركه بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(ws.."mute_gif"..msg.chat_id_)
redis:set(ws..":tqeed_gif:"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل المتحركه بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح المتحركه بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(ws..":tqeed_gif:"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح المتحركه بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )    end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل التوجيه بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(ws.."mute_forward"..msg.chat_id_)
redis:set(ws..":tqeed_fwd:"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل التوجيه بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح التوجيه  بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(ws..":tqeed_fwd:"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح التوجيه بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الروابط بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(ws..":tqeed_link:"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الروابط بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الروابط بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(ws..":tqeed_link:"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الروابط بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الصور بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(ws..":tqeed_photo:"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الصور بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الصور بالتقييد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(ws..":tqeed_photo:"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الصور بالتقييد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
---------------Lock twasel-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل التواصل    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(ws.."lock_twasel",true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل التواصل بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )    end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل التواصل    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(ws.."lock_twasel")
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل التواصل بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل تعيين الايدي للمطور    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else redis:set(ws.."lockidedit",true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل تعيين الايدي للمطور  بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل تعيين الايدي للمطور    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(ws.."lockidedit") 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل تعيين الايدي للمطور  بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end 
end,{msg=msg})
end 
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل اذاعه المطورين    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(ws.."lock_brod")
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل اذاعه المطورين بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل اذاعه المطورين    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:set(ws.."lock_brod",true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل اذاعه المطورين بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل الردود    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(ws.."replay"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل الردود بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل الردود    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:set(ws.."replay"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل الردود بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " )
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تعطيل نظام البوت خدمي    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(ws.."lock_service")
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تعطيل نظام البوت خدمي بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد تفعيل نظام البوت خدمي    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:set(ws.."lock_service",true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم تفعيل نظام البوت خدمي بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Lock mmno-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الفشار    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_mmno3"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الفشار بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الفشار    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_mmno3"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الفشار بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الفارسيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_pharsi"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الفارسيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الفارسيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_pharsi"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الفارسيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الانكليزيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_lang"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الانكليزيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الانكليزيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_lang"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الانكليزيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الروابط    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_link"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الروابط بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الروابط    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_link"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الروابط بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الاضافه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_Add"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الاضافه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الاضافه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_Add"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الاضافه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل التاك (#)    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_tag"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل التاك (#) بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح التاك (#)    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_tag"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح التاك (#) بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Lock UserName-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل المعرفات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_username"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل المعرفات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح المعرفات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_username"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح المعرفات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل التعديل    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_edit"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل التعديل بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح التعديل    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_edit"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح التعديل بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الكلايش    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_spam"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الكلايش بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الكلايش    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_spam"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الكلايش بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل التكرار    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_flood"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل التكرار بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح التكرار    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_flood"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح التكرار بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل البوتات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_bots"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل البوتات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح البوتات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_bots_by_kick"..msg.chat_id_)
redis:del(ws.."lock_bots"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح البوتات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الماركدوان    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_markdown"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الماركدوان بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الماركدوان    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_markdown"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الماركدوان بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الويب    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_webpage"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الويب بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الويب    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_webpage"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الويب بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Gif-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل المتحركه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_gif"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل المتحركه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
Tkml = "/G/?i="
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح المتحركه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_gif"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح المتحركه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Game-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الالعاب    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set("mute_game"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الالعاب بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الالعاب    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_game"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الالعاب بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Inline-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الانلاين    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_inline"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الانلاين بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الانلاين    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_inline"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الانلاين بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Text-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الدردشه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_text"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الدردشه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الدردشه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_text"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الدردشه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute photo-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الصور    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_photo"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الصور بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الصور    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_photo"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الصور بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الفيديو    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_video"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الفيديو بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الفيديو    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_video"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الفيديو بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Audio-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الصوت    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_audio"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الحظرالصوت بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الصوت    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_audio"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الصوت بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Voice-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل البصمات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_voice"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل البصمات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح البصمات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_voice"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح البصمات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Sticker-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الملصقات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_sticker"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الملصقات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الملصقات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_sticker"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الملصقات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Contact-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الجهات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_contact"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الجهات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الجهات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_contact"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الجهات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Forward-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل التوجيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_forward"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل التوجيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح التوجيه    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_forward"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح التوجيه بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Location-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الموقع    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_location"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الموقع بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الموقع    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_location"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الموقع بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute Document-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الملفات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_document"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الملفات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الملفات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_document"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الملفات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------Mute TgService-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الاشعارات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_tgservice"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الاشعارات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الاشعارات    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_tgservice"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الاشعارات بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل الكيبورد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."mute_keyboard"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل الكيبورد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح الكيبورد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."mute_keyboard"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح الكيبورد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل البوتات بالطرد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_bots"..msg.chat_id_,true)
redis:set(ws.."lock_bots_by_kick"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل البوتات بالطرد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح البوتات بالطرد    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_bots_by_kick"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح البوتات بالطرد بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
---------------locks pin-------------------
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد قفل التثبيت    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(ws.."lock_pin"..msg.chat_id_,true) 
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم قفل التثبيت بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم بالتأكيد فتح التثبيت    \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(ws.."lock_pin"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"★︎ تم فتح التثبيت بنجاح   \n⚶ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
